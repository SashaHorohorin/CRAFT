                        ...
                        <div className="trainingPage__modal modal-more-info">
                            {modalWorkout.type == "Игровая" ? (
                                ...
                                <p>
                                    ...
                                    <br />
                                    <br />
                                    Стоимость - 950 рублей разово, 750 рублей первая тренировка, 850 рублей
                                    при покупке абонемента на занятие 2 раза в
                                    неделю (7650 рублей единоразово 9 занятий),
                                    800 рублей - 3 раза в неделю (9600, 12
                                    занятий). Аренда ракетки - 150 рублей.
                                    <br />
                                    <br />
                                ...
                                <p>
                                    ...
                                    мини группе.<br />
                                    <br />
                                     Тренеры - Ирина Онегина,
                                    Дмитрий Решетников, Александр Хорохорин.
                                    Стоимость - 950 рублей разово, 850 рублей
                                    при покупке абонемента на занятие 2 раза в
                                    неделю (7650 рублей единоразово 9 занятий),
                                    800 рублей - 3 раза в неделю (9600, 12
                                    занятий). Аренда ракетки - 150 рублей.<br />
                                    <br />
                                    Обращайтесь по всем вопросам 89062783095<br />
                                    <br />
