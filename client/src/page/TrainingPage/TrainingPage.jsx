                    ...
                    <div className="trainingPage__modal modal-more-info">
                        {modalWorkout.type == "Игровая" ? (
                            ...
                            <p>
                                ...
                                <br />
                                Стоимость в филиале{" "}
                                {nameMode(modalWorkout.sportComplex)} – 1000
                                разовая – есть система абонементов. В других
                                филиалах – от 1150 до 1350 в мини-группах.
                                <br />
                                <br />
                        ...
                        "Мастер+" ? (
                          <p>
                              ...
                              <br />
                              Стоимость участия - 2500 рублей плюс ваши перьевые воланы.
                              <br />
                              <br />
                              По всем вопросам обращайтесь
                              <a href="tel:+79030975817">+7(903) 097 58 17</a>
