    ...
    return (
        <>
            ...
            >
                    ...
                    <div className="trainingPage__modal modal-more-info">
                        {modalWorkout.type == "Игровая" ? (
                            <p>
                                ...
                                <br />
                                <br />
                                Оплата тренировки происходит переводом на
                                тинькоф по номеру:{" "}
                                <a href="tel:+79030975817">+7(903) 097 58 17</a>
                            </p>
                        ) : modalWorkout.type == "Игровая с тренером" ? (
                            <p>
                                Игровая с тренером Александром Хорохориным на 1
                                корте в мини группе.
                                <br />
                                <br />
                                Что даёт такая игровая? Постоянную корректировку
                                от тренера: игра по зонам, парные перемещения,
                                выбор удара . Наиболее эффективно приобретённый
                                навык закрепляется, если его сразу же начать
                                применять в игре и желательно под чутким
                                руководством тренера.
                                <br />
                                <br />
                                Чтобы тренировка состоялась, необходим кворум 3
                                человека. В группе максимум 5 человек. Уровень
                                игроков - не менее 250 по ЛАБ. Если нет
                                рейтинга, допуск на усмотрение организаторов.
                                <br />
                                <br />
                                Стоимость - 950 рублей разово, 750 рублей первая
                                тренировка, 850 рублей при покупке абонемента на
                                занятие 2 раза в неделю (7650 рублей единоразово
                                9 занятий), 800 рублей - 3 раза в неделю (9600,
                                12 занятий). Аренда ракетки - 150 рублей.
                                <br />
                                <br />
                            ...
                            <p>
                                Тренировка с тренером на 1 или 2 кортах в мини
                                группе.
                                <br />
                                <br />
                                ...
                                <br />
                                <br />
                                Необходим кворум 4 человека, чтобы тренировка
                                состоялась!
                                <br />
                                <br />
                                Оплата тренировки происходит переводом на
                ...
                >
                    <div className="trainingPage__modal modal-more-info">
                        Пробная тренировка по цене 750 руб, акция работает на
                        ТРЕНИРОВКА С ТРЕНЕРОМ и ТАКТИЧЕСКАЯ ИГРОВАЯ.
                        <br /> Записаться вы можете на этой странице. <br />
                        <br />
                        Чтобы закрыть информационное окно нажмите на любую часть
                        экрана.
                        <br />
                        <br />
                        Оплата тренировки происходит переводом на тинькофф по
                        номеру: <a href="tel:+79030975817">+7(903) 097 58 17</a>
                    </div>
                </div>
