...
const cities = [
    ...
    },
    {
        ...
        address: "СК Импульс, Сертолово, м Озерки, пр. Просвещения.",
        text: "На автобусе 25-35 минут, на машине 10-20 минут от метро Отличный зал: хороший свет, профессиональное покрытие, есть парковка на территории, раздевалки, душ.",
    },
    {
        id: 3,
        ongitude: 60.013032,
