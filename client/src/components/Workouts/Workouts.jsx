                    ...
                    <div className="workout__row">
                        ...
                        <div className="workout__column">
                            <div className="workout__time time-workout">
                                <div className="time-workout__label">Время</div>
                                <div className="time-workout__interval">18:30 - 20:00</div>
                            </div>
                        </div>
                        <div className="workout__column">
                            <div className="workout__trainer trainer-workout">
                                <div className="trainer-workout__label">Тренер</div>
                                <div className="trainer-workout__name">Хорохорин Александр</div>
                            </div>
                        </div>
                        <div className="workout__column">
                            <div className="workout__actions actions-workout">
                                ...
                                <div className="actions-workout__btn btn-workout">Записаться</div>
                            </div>
                        </div>
                    </div>
                </div>
